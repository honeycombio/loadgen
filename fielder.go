...
// Fielder is a function that takes a name and a count and generates a map of random fields based on using the name as a random seed.
// The count is the number of fields to generate.
// The field names are randomly generated by combining an adjective and a noun.
func NewFielder(name string, count int) *Fielder {
